...
gsap.from('.about__text', {opacity: 0, duration: 3, delay: 4, y: 25, ease:'expo.out', stagger: .2})

gsap.from('.inner', {opacity: 0, duration: 3, delay: 4, y: 25, ease:'expo.out', stagger: .2})

gsap.from('.container', {opacity: 0, duration: 3, delay: 3.2, y: 25, ease:'expo.out', stagger: .2})

gsap.from('.hww', {opacity: 0, duration: 3, delay: 3.2, y: 25, ease:'expo.out', stagger: .2})
